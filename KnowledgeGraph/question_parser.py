class QuestionPaser:
    ...
    def sql_transfer(self, question_type, entities):
        ...
        # 名词解释问题
            ...
            sql += ["MATCH (m:产品类型) where m.名词 = '{0}' or '{0}' in m.别名  return m.名词, m.定义, m.特性, m.适用人群".format(i) for i in entities[0]]
            sql += ["MATCH (m:投资性质) where m.名词 = '{0}' or '{0}' in m.别名  return m.名词, m.定义, m.特性, m.适用人群".format(i) for i in entities[0]]
            sql += ["MATCH (m:收益类型) where m.名词 = '{0}' or '{0}' in m.别名  return m.名词, m.特性, m.适用人群".format(i) for i in entities[0]]
            sql += ["MATCH (m:运作模式) where m.名词 = '{0}' or '{0}' in m.别名  return m.名词, m.定义".format(i) for i in entities[0]]
        ...
        # 名词解释问题
            ...
            sql += ["MATCH (m:费用) where m.名词 = '{0}' or '{0}' in m.别名  return m.名词, m.定义".format(i) for i in entities[0]]
            sql += ["MATCH (m:产品要素) where m.名词 = '{0}' or '{0}' in m.别名 return m.名词, m.定义".format(i) for i in entities[0]]
            sql += ["MATCH (m:资产运作) where m.名词 = '{0}' or '{0}' in m.别名 return m.名词, m.定义".format(i) for i in entities[0]]
            sql += ["MATCH (m:信息披露) where m.名词 = '{0}' or '{0}' in m.别名 return m.名词, m.定义".format(i) for i in entities[0]]
            sql += ["MATCH (m:流动性安排) where m.名词 = '{0}' or '{0}' in m.别名 return m.名词, m.定义".format(i) for i in entities[0]]
            sql += ["MATCH (m:投资资产) where m.名词 = '{0}' return m.名词, m.类型".format(i) for i in entities[0]]
        ...
        # 询问产品注意事项问题   针对与购买产品的注意事项  针对与某一属性产品的注意事项
            ...
            sql += ["MATCH (m:投资性质) where m.名词 = '{0}' or '{0}' in m.别名  return m.名词, m.定义, m.特性, m.适用人群".format(i) for i in entities[0]]
            sql += ["MATCH (m:收益类型) where m.名词 = '{0}' or '{0}' in m.别名  return m.名词, m.特性, m.适用人群".format(i) for i in entities[0]]
            sql += ["MATCH (m:运作模式) where m.名词 = '{0}' or '{0}' in m.别名  return m.名词, m.开放形态, m.产品类型".format(i) for i in entities[0]]
            sql += ["MATCH (m:管理主体) where m.名词 = '{0}' or '{0}' in m.别名  return m.名词, m.定义, m.特性".format(i) for i in entities[0]]
            sql += ["MATCH (m:风险等级) where m.名词 = '{0}' or '{0}' in m.别名  return m.名词, m.特性".format(i) for i in entities[0]]
            ...
            sql += [
                "MATCH (m:理财产品)-[]->(n:募集方式) where m.产品名称 = '{0}' or m.登记编码 = '{0}' return m.产品名称, n.名词, n.定义, n.特性, n.适用人群".format(i) for i in entities[0]]
            sql += [
                "MATCH (m:理财产品)-[]->(n:开放形态) where m.产品名称 = '{0}' or m.登记编码 = '{0}' return m.产品名称, n.名词, n.定义, n.特性, n.适用人群".format(i) for i in entities[0]]
            sql += [
                "MATCH (m:理财产品)-[]->(n:产品类型) where m.产品名称 = '{0}' or m.登记编码 = '{0}' return m.产品名称, n.名词, n.定义, n.特性, n.适用人群".format(i) for i in entities[0]]
            sql += [
                "MATCH (m:理财产品)-[]->(n:投资性质) where m.产品名称 = '{0}' or m.登记编码 = '{0}' return m.产品名称, n.名词, n.定义, n.特性, n.适用人群".format(i) for i in entities[0]]
            sql += [
                "MATCH (m:理财产品)-[]->(n:收益类型) where m.产品名称 = '{0}' or m.登记编码 = '{0}' return m.产品名称, n.名词, n.特性, n.适用人群".format(i) for i in entities[0]]
            sql += [
                "MATCH (m:理财产品)-[]->(n:运作模式) where m.产品名称 = '{0}' or m.登记编码 = '{0}' return m.产品名称, n.名词, n.开放形态, n.产品类型".format(i) for i in entities[0]]
            sql += [
                "MATCH (m:理财产品)-[]->(n:管理主体) where m.产品名称 = '{0}' or m.登记编码 = '{0}' return m.产品名称, n.名词, n.定义, n.特性".format(i) for i in entities[0]]
            sql += [
                "MATCH (m:理财产品)-[]->(n:风险等级) where m.产品名称 = '{0}' or m.登记编码 = '{0}' return m.产品名称, n.名词, n.特性".format(i) for i in entities[0]]
        ...
        # 介绍产品概要信息
            ...
            sql = [
                "MATCH (m:理财产品) where m.产品名称 = '{0}' or m.登记编码 = '{0}' return m.产品名称, m.登记编码, m.期限类型, m.业绩比较基准".format(
                    i) for i in entities[0]]
            sql += ["MATCH (m:理财产品)-[]->(n:发行/托管机构) where m.产品名称 = '{0}' or m.登记编码 = '{0}' return n.名称".format(
                    i) for i in entities[0]]

            sql += ["MATCH (m:理财产品)-[]->(n:募集方式) where m.产品名称 = '{0}' or m.登记编码 = '{0}' return n.名词".format(
                    i) for i in entities[0]]

            sql += ["MATCH (m:理财产品)-[]->(n:运作模式) where m.产品名称 = '{0}' or m.登记编码 = '{0}' return n.名词".format(
                    i) for i in entities[0]]

            sql += ["MATCH (m:理财产品)-[]->(n:投资性质) where m.产品名称 = '{0}' or m.登记编码 = '{0}' return n.名词".format(
                    i) for i in entities[0]]
        ...
        # 询问某区域某银行的支行  “广东哪里有汇丰银行”     #不能够具体到哪个市 需要创建市节点 添加关系
        elif question_type == 'area_subbank_addr':
            sql = [
                "MATCH (m:支行)-[r:所属总行]->(n:银行) where (n.名称 = '{1}' or '{1}' in n.别名) and m.区域  CONTAINS '{0}' return n.名称, m.区域, m.名称, m.具体地址 ".format(
                    i, j) for i in entities[0] for j in entities[1]]

        # 询问银行在某地区的支行信息  “汇丰银行在广东有哪些支行/网点”
        elif question_type == 'area_subbank':
            sql = [
                "MATCH (m:支行)-[r:所属总行]->(n:银行) where (n.名称 = '{1}' or '{1}' in n.别名) and m.区域 CONTAINS '{0}' return n.名称, m.区域, m.名称".format(
                    i, j) for i in entities[0] for j in entities[1]]
        ...
        # 询问某银行在某地区的总数
            ...
            sql = [
                "MATCH (m:支行)-[r:所属总行]->(n:银行) where (n.名称 = '{1}' or '{1}' in n.别名) and m.区域 CONTAINS '{0}' return n.名称,m.区域,count(r)".format(
                    i, j) for i in entities[0] for j in entities[1]]

        # 询问某理财产品销售区域
        elif question_type == 'product_area':
            sql = [
                "MATCH (m:理财产品)-[r:销售地区]->(n:区域) where (m.产品名称 = '{0}' or m.登记编码 = '{0}') return m.产品名称, n.名称".format(
                    i) for i in entities[0]]
        ...
        # 询问某产品的面向的用户
            ...
            sql = ["MATCH (m:理财产品)-[]->(n:属性类别) where (m.产品名称 = '{0}' or m.登记编码 = '{0}')  return m.产品名称, n.适用人群".format(i)
                   for i in entities[0]]

        # 询问某投资资产所属资产类别
        elif question_type == 'investment_category':
            sql = ["MATCH (m:投资资产)-[]->(n:投资资产类型) where (m.名词 = '{0}' or '{0}' in m.名词) return m.名词, n.名词  ".format(i)
                   for i in entities[0]]

        # 确认某投资资产是否属于某资产类别
        elif question_type == 'if_investment_category':
            sql = [
                "MATCH (m:投资资产)-[]->(n:投资资产类型) where (m.名词 = '{0}' or '{0}' in m.名词) and （n.名词='{1}' and  '{1}' in n.名词 return m.名词, n.名词".format(
                    i, j) for i in entities[0] for j in entities[1]]
            sql += ["MATCH (m:投资资产)-[]->(n:投资资产类型) where (m.名词 = '{0}' or '{0}' in m.名词) return m.名词, n.名词  ".format(i)
                   for i in entities[0]]
        ...
        # 询问某发行机构所属的机构类别
            ...
            sql = ["MATCH (m:发行/托管机构)-[]->(n:机构类别) where m.名称 = '{0}' return m.名称, n.名词".format(i) for i in entities[0]]

        # 询问某发行机构所属的总行
        elif question_type == 'institution_bank':
            sql = ["MATCH (m:发行/托管机构)-[]->(n:银行) where m.名称 = '{0}' return m.名称, n.名称".format(i) for i in entities[0]]

        # 判断某产品的某属性是否为某类别
        elif question_type == 'if_category':
            sql = ["MATCH (m:理财产品)-[]->(p:属性类别)-[]->(n:产品属性) where (m.产品名称 = '{0}' or m.登记编码 = '{0}') and (p.名称 = '{1}' or '{1}' in p.别名) return m.产品名称, p.名词, n.名称".format(
                    i, j) for i in entities[0] for j in entities[1]]
            sql += ["MATCH (m:理财产品)-[]->(p:属性类别)-[]->(n:产品属性) where (m.产品名称 = '{0}' or m.登记编码 = '{0}') and (p.名称 = '{1}' or '{1}' in p.别名) WITH m.产品名称, p.名词, n.名称 MATCH (x:理财产品)-[]->(y:属性类别)-[]->(z:产品属性) where x.产品名称 = m.产品名称 and z.名称=n.名称 return x.产品名称, y.名词, z.名称".format(
                    i, j) for i in entities[0] for j in entities[1]]
        ...
        # 询问某产品的时间属性
            ...
            for j in entities[1]:
                if j in '募集起始日期':
                    entities_.append('募集起始日期')
                elif j in '募集结束日期':
                    entities_.append('募集结束日期')
                elif j in '产品起始日期':
                    entities_.append('产品起始日期')
                elif j in '产品终止日期':
                    entities_.append('产品终止日期')
                elif j in '产品状态':
                    entities_.append('产品状态')
                elif j in '业务起始日':
                    entities_.append('业务起始日')
                elif j in '产品起始日期':
                    entities_.append('产品起始日期')
                elif j in '产品终止日期':
                    entities_.append('产品终止日期')
                elif j in '业务结束日':
                    entities_.append('业务结束日')
                elif j in '业务起始日':
                    entities_.append('业务起始日')
                elif j in '实际天数（天）':
                    entities_.append('实际天数（天）')
                else:
                    entities_.append(j)
                entities[1]=entities_
        ...
        # 询问某属性的不同类之间的差别  问：“某个属性的不同类别之间的差异，” “某个类别和其他类别的差异”
            ...
            sql = ["MATCH (m:属性类别)-[r:相关类别]->(n:属性类别) where m.名词 = '{0}' or '{0}' in m.别名  return m.名词, r.different, n.名词".format(
                    i) for i in entities[0]]

        # 询问某属性的下的其他类别
        elif question_type == 'other_category':
            sql = ["MATCH (m:属性类别)-[r:相关类别]->(n:属性类别) where m.名词='{0}' or '{0}' in m.别名 return m.名词, r.name, n.名词".format(
                    i) for i in entities[0]]
        ...
        # 寻求产品类型推荐    具体产品不做推荐哦！
            ...
            sql = ["MATCH (m:属性类别)-[]->(n:用户类型) where n.名词 = '{0}' or '{0}' in n.别名  return n.名词, m.名词".format(i) for i in entities[0]]

        # 判断某类产品是否适合某类人群
        elif question_type == 'if_recommend_category':
            sql = ["MATCH (m:属性类别)-[]->(n:用户类型) where (n.名词 = '{0}' or '{0}' in n.别名) and (m.名词='{1}' or '{1}' in m.名词) return n.名词, m.名词".format(i,j) for i in entities[0] for j in entities[1]]
            sql += ["MATCH (m:属性类别)-[]->(n:用户类型) where (n.名词 = '{0}' or '{0}' in n.别名) return n.名词, m.名词".format(i,j) for i in entities[0] for j in entities[1]]


        # 询问某产品现在可以购买否
        elif question_type == 'if_buy':
            sql = ["MATCH (m:理财产品) where (m.产品名称 = '{0}' or m.登记编码 = '{0}') return m.产品名称, m.产品状态".format(i) for i in
                   entities[0]]
