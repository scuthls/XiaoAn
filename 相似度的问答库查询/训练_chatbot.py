...
def get_id_list_from(sentence):
    ...
    for str_ in seg_list:
        id_ = wordToken.word2id(str_)
        if id_:
            sentence_id_list.append(wordToken.word2id(str_))
...
def get_train_set():
    ...
    train_set = []
    with open('./seqdata/question.txt', 'r', encoding='utf-8') as question_file:
        with open('./seqdata/answer.txt', 'r', encoding='utf-8') as answer_file:
            while True:
